...
class __TwigTemplate_0ec2582feb5633be7c90838393846caaba31cb02e3b42e68294b172c3a439341 extends Twig_Template
{
...
<html lang=\"en\">
    <head>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["a"]) {
            if (($this->getAttribute((isset($context["a"]) ? $context["a"] : null), "id") == "28")) {
        ...
        <link rel=\"canonical\" href=\"https://www.ratetrade.ca/mortgage-affordability\">  
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
        echo "\"> 
         <meta name=\"keywords\" content=\"Td Mortgage Affordability Calculator, Scotiabank Mortgage Affordability Calculator, Rbc Mortgage Affordability Calculator, Cmhc Affordability Calculator, Mortgage Qualification Calculator, Most Accurate Mortgage Affordability Calculator, Cibc Mortgage Calculator, Bmo Mortgage Affordability Calculator\" >
...
<link rel=\"stylesheet\" type=\"text/css\" href=\"/./bundles/acmedemo/css/jquery-ui.css\">";
    ...
    <div class=\"post-media\">
        <div class=\"content-boxes framecontent\">
            <div class=\"calc\">
                <table class=\"tablem tableafford\">
                    <tr>
                        <td>
                            Province
                ...
                <table class=\"tablem tableafford\">
                    ...
                    <tr>
                        <td>Annual Income: <span>(Before Tax)</span></td>
                        <td>
                            <input type=\"text\" class=\"annual-income add-dollor\" value=\"\" >
                        </td>

                        <td>Co-Applicant Income: <span>(Before Tax)</span></td>
                        <td>
                ...
                <table class=\"tablem debtshead\">
                    <tr>
                        <th colspan=\"2\">Monthly debt payments</th>
                        <th colspan=\"2\">Monthly Living Costs</th>
                    </tr>
                    <tr>
                        <td>
                            Credit Card
                        ...
                        <td><input type=\"text\" class=\"property-tax add-dollor\" value=\"\" > <input type=\"checkbox\" class=\"property-tax-check\" checked ></td>
                    </tr>
                    <tr>
                        <td>
                            Car Payment
                        ...
                        <td><input type=\"text\" class=\"condo add-dollor\" value=\"\" ><input type=\"checkbox\" class=\"condo-check\" checked ></td>
                    </tr>
                    <tr>
                        <td>
                            Other Loan Expenses
                        ...
                        <td><input type=\"text\" class=\"heating-cost add-dollor\" value=\"\" ><input type=\"checkbox\" class=\"heating-cost-check\" checked ></td>
                    </tr>
                    <tr>
                        <td colspan=\"4\" style=\"text-align: center;\"><input type=\"button\" class=\"how-afford\" value=\"How much can I afford?\" ></td>
                    </tr>
                </table>
            </div>

            <div class=\"calc\">
                <table class=\"tablem affordresult\">
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        <td>Mortgage rate</td>
                        <td>
                            <input type=\"text\" value=\"2.42\" id=\"rateval\" class=\"rateval\" disabled=\"disabled\" >
        ...
        echo "\"></script>
            <script>
                    ...
                    if (
                        ...
                        \$.ajax({
                            ...
                            success: function (response) {
                                ...
                                \$(\"#graph-downpay-div\").append(
                                    '<select class=\"ammort-graph\">\\n\\
                ...
                function getAmmortSchedule() {
                    ...
                    var principals = parseInt(
                        \$(\".reqdmortgage\")
                            .eq(\$(\".ammort-graph\").find(\"option:selected\").val())
                            .html()
                            .replace(/[^0-9-.]/g, \"\")
                    );
            ...
            <th id=\"paidtodateheader\">Loan Paid To Date</th>\\n\\
                 ...
                 <td id=\"year' +
                                    data[\"schedule\"][i][\"year\"] +
                                    '\" class=\"paymentyear toggle\">' +
                                    data[\"schedule\"][i][\"year\"] +
                                    '</td>\\n\\
                 <td class=\"currency\">' +
                                    formatdollor2(data[\"schedule\"][i][\"yprincipal\"], \"\$\") +
                                    '</td>\\n\\
                 <td class=\"currency\">' +
                                    formatdollor2(data[\"schedule\"][i][\"interest\"], \"\$\") +
                                    '</td>\\n\\
                 <td class=\"currency\">' +
                                    formatdollor2(data[\"schedule\"][i][\"installment\"], \"\$\") +
                                    '</td>\\n\\
                 <td class=\"currency\">' +
                                    formatdollor2(data[\"schedule\"][i][\"balance\"], \"\$\") +
                                    '</td>\\n\\
                 <td class=\"paidtodateyear\">' +
                                    data[\"schedule\"][i][\"loan_returned\"] +
                                    '%</td></tr>\\n\\
                 <tr id=\"monthyear' +
                                    data[\"schedule\"][i][\"year\"] +
                  ...
                  <table>';
                                for (var j = 0; j < data[\"schedule\"][i][\"months\"].length; j++) {
                                    str +=
                                        '<tr style=\"color:blue;\"><td class=\"paymentmonthyear\">' +
                                        data[\"schedule\"][i][\"months\"][j][\"month\"] +
                                        '</td>\\n\\
                       <td class=\"currency\">' +
                                        formatdollor2(data[\"schedule\"][i][\"months\"][j][\"principal\"], \"\$\") +
                                        '</td>\\n\\
                       <td class=\"currency\">' +
                                        formatdollor2(data[\"schedule\"][i][\"months\"][j][\"interest\"], \"\$\") +
                                        '</td>\\n\\
                       <td class=\"currency\">' +
                                        formatdollor2(data[\"schedule\"][i][\"months\"][j][\"installment\"], \"\$\") +
                                        '</td>\\n\\
                       <td class=\"currency\">' +
                                        formatdollor2(data[\"schedule\"][i][\"months\"][j][\"balance\"], \"\$\") +
                                        '</td>\\n\\
                       <td class=\"paidtodatemonthyear\">' +
                                        data[\"schedule\"][i][\"months\"][j][\"loan_returned_month\"] +
                                        \"%</td></tr>\";
                                }
            ...
            <div class=\"calinfo\">
                ...
                <p>
                    Before you take a mortgage loan, you must know whether you can afford the same or not. This is very crucial to understand because your entire monthly or yearly budget can depend on the same. Once you become sure about
                    the affordability of the mortgage, then you can easily plan your next financial moves throughout the year. To ensure the affordability of the mortgage loan you can take the help of our
                    <b>mortgage affordability calculator</b>.
                </p>
                <p>
                    At Rate Trade, we always try to help our clients in getting an easy, smooth and fast process for their mortgage loan. We try to help them with the right services so that they can make themselves completely prepared and
                    well-versed about such type of financial deals.
                </p>
                ...
                <p>
                    There are two ratios that the lenders look at while determining your affordability; one is the Gross Debt Service or GDS and the other one is Total Debt Service or TDS. They consider your monthly income as well as total
                    debt load while offering you the loan.
                </p>
                <h5><strong>What Is The Use Of The Calculator</strong></h5>
                <p>
                    The calculator will help you to understand your affordability for a certain property. You need to submit the information on the calculator that is essential to check your affordability. Once you give all these details
                    about your income, expenses and the cost of the home, then our calculator will start calculating the result. This result will show you whether you can afford that home or not as per your present financial status.
                </p>
...
";
    ...
    {
        return array (  1254 => 1015,  1134 => 897,  1123 => 894,  1117 => 892,  1113 => 891,  1109 => 890,  1064 => 847,  1037 => 821,  1026 => 818,  1024 => 817,  1020 => 816,  1013 => 810,  1002 => 807,  1000 => 806,  996 => 805,  988 => 798,  977 => 795,  975 => 794,  971 => 793,  962 => 785,  958 => 784,  954 => 783,  950 => 782,  946 => 781,  941 => 779,  937 => 778,  933 => 777,  929 => 776,  902 => 752,  404 => 257,  400 => 256,  396 => 255,  205 => 66,  185 => 47,  178 => 41,  174 => 40,  170 => 39,  166 => 38,  162 => 37,  158 => 36,  154 => 35,  150 => 34,  146 => 33,  142 => 32,  138 => 31,  134 => 30,  131 => 29,  113 => 21,  100 => 20,  84 => 16,  71 => 15,  55 => 11,  42 => 10,  24 => 4,  19 => 1,);
    }
}
