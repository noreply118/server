 ...
 */
class WpPostmeta extends \Main\RatetradeBundle\Entity\WpPostmeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpPostmeta' . "\0" . 'postId', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpPostmeta' . "\0" . 'metaKey', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpPostmeta' . "\0" . 'metaValue', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpPostmeta' . "\0" . 'metaId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WpPostmeta $proxy) {
