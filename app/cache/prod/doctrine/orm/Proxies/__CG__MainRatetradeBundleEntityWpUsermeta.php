 ...
 */
class WpUsermeta extends \Main\RatetradeBundle\Entity\WpUsermeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpUsermeta' . "\0" . 'userId', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpUsermeta' . "\0" . 'metaKey', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpUsermeta' . "\0" . 'metaValue', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpUsermeta' . "\0" . 'umetaId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WpUsermeta $proxy) {
    ...
    public function getUmetaId()
    {
        if ($this->__isInitialized__ === false) {
            return  parent::getUmetaId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUmetaId', array());
