 ...
 */
class WpCommentmeta extends \Main\RatetradeBundle\Entity\WpCommentmeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpCommentmeta' . "\0" . 'commentId', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpCommentmeta' . "\0" . 'metaKey', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpCommentmeta' . "\0" . 'metaValue', '' . "\0" . 'Main\\RatetradeBundle\\Entity\\WpCommentmeta' . "\0" . 'metaId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WpCommentmeta $proxy) {
