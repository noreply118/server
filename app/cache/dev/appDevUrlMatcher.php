...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/new-rates') {
            return array (  '_controller' => 'Main\\RatetradeBundle\\Controller\\DefaultController::NewRateAction',  '_route' => 'new_rates',);
        }

        // error500
        if ($pathinfo === '/500') {
            return array (  '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController::templateAction',  'template' => 'TwigBundle:Exception:error500.html.twig',  '_route' => 'error500',);
        }
