...
function getEquity() 
{
    ...
    if (equity <= 0)
    {
        ...
        jQuery("#mortamount").html(Globalize.format(Math.round(num), "n", "en-US"));
        jQuery("#left-amount").html(Globalize.format(Math.round(mortgage), "n", "en-US"));
    }
    else
    {
       ...
       jQuery("#new-mort").val(Globalize.format((parseInt(jQuery("#equityamount").val().replace(/[^\d\.]/g,
        ...
        jQuery("#msg").html('' + Globalize.format(Math.abs(equity), "n", "en-US") + '</span>');
        jQuery("#left-amount").html(Globalize.format(Math.round(mortgage), "n", "en-US")); 
        jQuery("#mortamount").html(Globalize.format(Math.round(num), "n", "en-US"));
...
function debt_console()
{
    ...
    jQuery("#total-debt").val('$'+Globalize.format((total_debt + parseInt($("#leftamount").val().replace(/[^\d\.]/g,
                ""))), "n", "en-US"));
